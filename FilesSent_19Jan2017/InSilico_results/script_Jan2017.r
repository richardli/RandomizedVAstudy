...
for(site in sites){
	...
	raw <-  read.csv(paste0("../FilesSent_19Jan2017/PHMRC_", phmrc_name, "/PHMRC_IHME_allSites_Adult_12-69yrs.csv"))
	# need to fix the double ".csv" in some files
	raw.esl <- read.csv(paste0("../FilesSent_19Jan2017/", site, "/ESL_", site, "_Adult_12-69.csv"))
	...
	write.csv(out1[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 1, "_", site, "_12-69_InSilicoVA_format1.csv"), row.names = TRUE)
	write.csv(out2[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 1, "_", site, "_12-69_InSilicoVA_format2.csv"), row.names = TRUE)
	write.csv(out3[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 1, "_", site, "_12-69_InSilicoVA_format3.csv"), row.names = TRUE)
...
for(site in sites){
	...
	raw <-  read.csv(paste0("../FilesSent_19Jan2017/PHMRC_", phmrc_name, "/PHMRC_IHME_India_Adult_12-69yrs.csv"))
	# need to fix the double ".csv" in some files
	raw.esl <- read.csv(paste0("../FilesSent_19Jan2017/", site, "/ESL_", site, "_Adult_12-69.csv"))
	colnames(raw.esl)[52] <- colnames(raw)[52]
	colnames(raw.esl)[65] <- colnames(raw)[65]
	...
	write.csv(out1[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 2, "_", site, "_12-69_InSilicoVA_format1.csv"), row.names = TRUE)
	write.csv(out2[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 2, "_", site, "_12-69_InSilicoVA_format2.csv"), row.names = TRUE)
	write.csv(out3[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 2, "_", site, "_12-69_InSilicoVA_format3.csv"), row.names = TRUE)
...
for(site in sites){
	...
	write.csv(out1[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 3, "_", site, "_12-69_InSilicoVA_format1.csv"), row.names = TRUE)
	write.csv(out2[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 3, "_", site, "_12-69_InSilicoVA_format2.csv"), row.names = TRUE)
	write.csv(out3[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 3, "_", site, "_12-69_InSilicoVA_format3.csv"), row.names = TRUE)
...
for(site in sites){
	...
	write.csv(out1[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 4, "_", site, "_12-69_InSilicoVA_format1.csv"), row.names = TRUE)
	write.csv(out2[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 4, "_", site, "_12-69_InSilicoVA_format2.csv"), row.names = TRUE)
	write.csv(out3[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 4, "_", site, "_12-69_InSilicoVA_format3.csv"), row.names = TRUE)
...
for(site in sites){
	...
	write.csv(out1[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 5, "_", site, "_12-69_InSilicoVA_format1.csv"), row.names = TRUE)
	write.csv(out2[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 5, "_", site, "_12-69_InSilicoVA_format2.csv"), row.names = TRUE)
	write.csv(out3[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 5, "_", site, "_12-69_InSilicoVA_format3.csv"), row.names = TRUE)
...
for(site in sites){
	...
	write.csv(out1[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 6, "_", site, "_12-69_InSilicoVA_format1.csv"), row.names = TRUE)
	write.csv(out2[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 6, "_", site, "_12-69_InSilicoVA_format2.csv"), row.names = TRUE)
	write.csv(out3[[counter]],
		file = paste0("../FilesSent_19Jan2017/results/Experiment", 6, "_", site, "_12-69_InSilicoVA_format3.csv"), row.names = TRUE)
